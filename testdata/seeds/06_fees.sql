...
INSERT INTO fee_debits (id, type, plugin_policy_billing_id, public_key, amount)
...
INSERT INTO fee_debits (id, type, plugin_policy_billing_id, public_key, amount, charged_at)
...
INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000003', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000005', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000007', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000009', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000011', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000013', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO fee_credits (id, type, transaction_hash, public_key, amount)
VALUES ('00000000-0000-0000-0000-000000000015', 'fee_transacted', '0x1234567890abcdef', '027e897b35aa9f9fff223b6c826ff42da37e8169fae7be57cbd38be86938a746c6', 30000)
ON CONFLICT (id) DO NOTHING;