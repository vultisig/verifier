...
CREATE OR REPLACE FUNCTION validate_fee_public_key(fee_public_key VARCHAR(42), billing_id uuid)
RETURNS BOOLEAN AS $$
BEGIN
...
DROP FUNCTION IF EXISTS validate_fee_public_key(VARCHAR(42), uuid);
