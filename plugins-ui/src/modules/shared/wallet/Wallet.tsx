...
import { DiscordIcon, TwitterIcon, GitHubIcon, DisconnectIcon } from "../icons/SocialIcons";
import "./wallet.styles.css";

const Wallet = () => {
  const { isConnected, walletAddress, connectWallet, disconnect, chain } = useWallet();
